 ...
 * @date 01/01/2020
 */
public class DeclMethod1 extends AbstractDeclMethod
{
    ...
    private static final Logger LOG = Logger.getLogger(DeclMethod1.class);
    /*public DeclMethod1(AbstractIdentifier type, AbstractIdentifier method, 
    ...
    protected void prettyPrintChildren(PrintStream s, String prefix) {
        ...
        //declVariables.prettyPrint(s, prefix, true);
    }
}
